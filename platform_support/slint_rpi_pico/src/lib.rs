// This code is copied from Slint mcu template https://github.com/slint-ui/slint-mcu-rust-template/blob/main/src/main.rs
...
pub fn init<F>(config: F) where F: FnOnce() {
    // -------- Setup Allocator --------
